...
public class SimpleUsersAuthenticatorProvider implements AuthenticationProvider {

	private final HttpSession httpSession = null;
	@Autowired
    private SimpleUsersPrincipalDetailService memberPrincipalDetailService;
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        SimpleUsersPrincipalDetails memberPrincipalDetails = (SimpleUsersPrincipalDetails) memberPrincipalDetailService.loadUserByUsername(username);
        // ====================================== 비밀번호 비교 ======================================
        ...
        // 인증이 성공하면 PrincipalDetails 객체를 반환한다.
        SimpleUsers member = memberPrincipalDetails.getMember();
        if (member == null || member.getEnabled() != true) {
        ...
        System.out.println("인증결과 : " + memberPrincipalDetails.getAuthorities());
